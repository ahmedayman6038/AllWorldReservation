...
namespace AllWorldReservation.web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Index([Bind(Include = "Id,UserName,Email,PhoneNumber,Address,CountryId,City,PostCode")] UserModel userModel)
        {
        ...
        public ActionResult Bookings()
        {
            ...
            var reservations = unitOfWork.ReservationRepository.Get(r => r.UserId == user.Id).OrderByDescending(p => p.CreatedDate);
